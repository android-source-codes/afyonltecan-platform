...
// SAMSUNG CHANGE + //P131023-01480 Crash in Browser
...
//SAMSUNG_CHANGE >>
    RenderObject* currRenderer =  parentNodeForRenderingAndStyle()->renderer();

    if (!currRenderer)
        return;
   
    currRenderer->addChild(newRenderer, nextRenderer());
